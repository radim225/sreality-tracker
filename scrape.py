...
<div class="card" id="podHarfouCard">
  ...
  <table id="tblPod">
    <thead>
      <tr>
        <th>Title</th><th>Type</th><th>Disp.</th><th>Price</th><th>m²</th><th>Kč/m²</th>
      </tr>
    </thead>
    <tbody></tbody>
  </table>
...
function renderPodHarfou() {{
  ...
  tbody.innerHTML = rows.length ? rows.map(r => `
    ...
    </tr>`).join("") : `<tr><td colspan="6" style="color:#888;">No other Pod Harfou listings currently found.</td></tr>`;
}}
